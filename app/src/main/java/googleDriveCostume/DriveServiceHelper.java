...
public class DriveServiceHelper {
    ...
    public static DriveServiceHelper getInstance()
    {
        if (single_instance == null)
            single_instance = new DriveServiceHelper();
    ...
    //creates a folder in the user's google drive root with the name @folderName
    public Task<String> createFolder(final String folderName){
        return Tasks.call(mExecutor, new Callable<String>() {
            @Override
            public String call() throws Exception {
